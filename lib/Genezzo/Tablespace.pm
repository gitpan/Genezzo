#!/usr/bin/perl
#
# $Header: /Users/claude/fuzz/lib/Genezzo/RCS/Tablespace.pm,v 6.10 2005/01/30 09:55:54 claude Exp claude $
#
...
#    $VERSION     = 1.00;
    ...
    $VERSION = do { my @r = (q$Revision: 6.10 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r }; # must be all one line, for MakeMaker
