#!/usr/bin/perl
#
# $Header: /Users/claude/fuzz/lib/Genezzo/RCS/Tablespace.pm,v 6.11 2005/02/02 06:42:29 claude Exp claude $
#
...
#    $VERSION     = 1.00;
    ...
    $VERSION = do { my @r = (q$Revision: 6.11 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r }; # must be all one line, for MakeMaker
